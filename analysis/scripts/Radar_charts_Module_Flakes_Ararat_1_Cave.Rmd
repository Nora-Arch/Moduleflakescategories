---
title: "Chart Plots Module Flakes_Ararat_1_Cave"
author: "David Nora"
date: "2025-02-04"
...
df <- read.csv("C:\\Users\\David\\OneDrive - huji.ac.il\\Desktop\\Archaeology\\Publications\\In_Proguess\\PhD\\Theory and Methods\\Submission\\Moduleflakescategories\\analysis\\data\\raw_data\\Ararat_1_Cave_Edge_Modification.csv", 
...
p_radar_chart <- ggplot() +
  ...
  coord_fixed() +
  facet_wrap(~ Module) +
  labs(title = "Radar Charts for edge modification modules at Ararat-1 cave",
...
ggsave("C:\\Users\\David\\OneDrive - huji.ac.il\\Desktop\\Archaeology\\Publications\\In_Proguess\\PhD\\Theory and Methods\\Submission\\Moduleflakescategories\\analysis\\data\\derived_data\\radar_charts_Ararat_1_Cave.png", plot = p, width = 12, height = 8, dpi = 300, bg = 'white')
```
