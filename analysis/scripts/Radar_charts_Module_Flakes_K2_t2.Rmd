...
df <- read.csv("C:\\Users\\David\\OneDrive - huji.ac.il\\Desktop\\Archaeology\\PhD_archaeological_sites\\Lithic_Analysis_Kalavan_T1_T2_Ararat_1_Cave\\Input\\Edge_Modification\\Kalavan_2_T2_Edge_Modification.csv", 
...
ggsave("radar_charts_Kalavan_2_T2.png", plot = p, width = 12, height = 8, dpi = 300, bg = 'white')
```